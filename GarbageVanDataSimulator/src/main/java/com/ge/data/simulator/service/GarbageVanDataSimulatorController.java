...
import com.ge.data.simulator.model.Locomotive;
import com.ge.data.simulator.model.LocomotiveGatewayType;
import com.ge.data.simulator.model.RPMData;
import com.ge.data.simulator.model.TorqueData;

@RestController
public class GarbageVanDataSimulatorController implements EnvironmentAware {
	
	private static final Log logger = LogFactory.getLog(GarbageVanDataSimulatorController.class);
...
//		generateSimulatorData();
	...
	public void generateSimulatorData() {
		...
		for (Locomotive locomotive : Locomotive.values()) {
			...
			final String uri = "http://garbagevandatasimulator.run.aws-usw02-pr.ice.predix.io/SaveTimeSeriesData";
		    ...
		    mvm.add("clientId", "engine_telematics");
		    mvm.add("tenantId", "01ed4ab5-5548-4168-bc9a-1a94f6594c41");
